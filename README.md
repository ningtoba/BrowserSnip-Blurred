...
| Stage | Speed |
|-------|-------|
| Face detection (YuNet) | ~30ms/frame (WASM) |
| Face recognition (MFN) | ~50ms/face (batched) |
...
- [InsightFace](https://github.com/deepinsight/insightface) — MobileFaceNet recognition model
